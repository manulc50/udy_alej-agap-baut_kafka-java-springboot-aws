...
public class KafkaConfiguration {
	...
	// Para la creación de un ConsumerFactory, es necesaio indicar el tipo de la clave, o key, de los mensajes y el tipo del valor de los mensajes que se van a consumir. En este caso, tanto la clave, o key, como el valor de los mensaje son de tipo String
	@Bean
	...
	// Para la creación de este listener, es necesaio indicar el tipo de la clave, o key, de los mensajes y el tipo del valor de los mensajes que se van a consumir. En este caso, tanto la clave, o key, como el valor de los mensaje son de tipo String
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, String> listenerContainerFactory(){
		...
		listenerContainerFactory.setConcurrency(50); // Consumo concurrente con 50 hilos
